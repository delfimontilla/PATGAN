...
class UNet(nn.Module): 
    ...
    def forward(self, x):
        ...
        conv1_dim1 = x.shape[2]
        conv1_dim2 = x.shape[3]
        x = self.max1(x)
        ...
        conv2_out = x
        conv2_dim1 = x.shape[2]
        conv2_dim2 = x.shape[3]
        x = self.max2(x)
        ...
        conv3_out = x
        conv3_dim1 = x.shape[2]
        conv3_dim2 = x.shape[3]
        x = self.max3(x)
        ...
        conv4_out = x
        conv4_dim1 = x.shape[2]
        conv4_dim2 = x.shape[3]
        x = self.max4(x)
        ...
        x = self.up_1(x)
        #print('up_1', x.shape)
        lower1 = int((conv4_dim1 - x.shape[2]) / 2)
        upper1 = int(conv4_dim1 - lower1)
        lower2 = int((conv4_dim2 - x.shape[3]) / 2)
        upper2 = int(conv4_dim2 - lower2)
        conv4_out_modified = conv4_out[:, :, lower1:upper1, lower2:upper2]
        #print(conv4_out_modified.shape)
        ...
        x = self.up_2(x)
        # print('up_2', x.shape)
        lower1 = int((conv3_dim1 - x.shape[2]) / 2)
        upper1 = int(conv3_dim1 - lower1)
        lower2 = int((conv3_dim2 - x.shape[3]) / 2)
        upper2 = int(conv3_dim2 - lower2)
        conv3_out_modified = conv3_out[:, :, lower1:upper1, lower2:upper2]
        ...
        x = self.up_3(x)
        # print('up_3', x.shape)
        lower1 = int((conv2_dim1 - x.shape[2]) / 2)
        upper1 = int(conv2_dim1 - lower1)
        lower2 = int((conv2_dim2 - x.shape[3]) / 2)
        upper2 = int(conv2_dim2 - lower2)
        conv2_out_modified = conv2_out[:, :, lower1:upper1, lower2:upper2]
        ...
        x = self.up_4(x)
        # print('up_4', x.shape)
        lower1 = int((conv1_dim1 - x.shape[2]) / 2)
        upper1 = int(conv1_dim1 - lower1)
        lower2 = int((conv1_dim2 - x.shape[3]) / 2)
        upper2 = int(conv1_dim2 - lower2)
        conv1_out_modified = conv1_out[:, :, lower1:upper1, lower2:upper2]
